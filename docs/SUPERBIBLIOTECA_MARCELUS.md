...
### Prompt master
- [Prompt Master Marcelus](../MARCELUS_MASTER.md)
- [Marcelus Master Plus](../masters/MARCELUS_MASTER_PLUS.md)

### Controllo qualita
- [Critica e ottimizzazione](CRITICA_E_OTTIMIZZAZIONE.md)
- [Indice generale prompt](INDICE_PROMPT.md)

## 2. Creativita, Comunicazione e Web
...
## 3. Formazione, Educazione e Studio
...
## 4. Sicurezza, Prevenzione e Cittadini
...
### Emergenze in autostrada
- [50 prompt Problemi in Autostrada](../prompts/17-autostrada-emergenze-legale/prompts.md)

### Prevenzione quotidiana
- [50 prompt Prevenzione Cittadini](../prompts/18-prevenzione-cittadini-emergenze/prompts.md)

Sotto-aree principali: blackout, caldo estremo, bollino rosso, anziani, bambini piccoli, alcol, farmaci, casa, condominio, quartiere, servizi locali.

## 5. Salute e Orientamento Sanitario

### Salute cittadini
- [100 prompt Salute Cittadini, Pronto Soccorso e Medico di Famiglia](../prompts/19-salute-cittadini-pronto-soccorso/prompts.md)

Sotto-aree principali: lunga attesa in Pronto Soccorso, sovraffollamento, triage, domande al medico, dimissioni, medico di famiglia, continuita assistenziale, referti, farmaci, liste d'attesa, prevenzione, anziani, bambini, viaggi e sanita digitale.

## 6. Programmazione, Rischio e Impresa

### Programmazione e risk management
...
## Regola d'uso Marcelus

1. Scegli la macro-area.
2. Apri la sotto-area piu vicina al problema reale.
3. Copia il prompt.
4. Sostituisci i campi tra parentesi quadre con dati veri.
5. Per salute, emergenze, legge e sicurezza: verifica sempre fonti ufficiali e professionisti competenti.

## Totale aggiornato

- Prompt pubblici Marcelus: 1450
- Prompt specialistico tesi universitaria: 1
- Totale pubblico indicizzato: 1451
- Prompt premium privati: 100
